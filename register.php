...
<body>
    ...
    <form data-toggle="validator" role="form" action="./services/register_service.php" method="post" class="login col-sm-4">
        ...
        <div class="form-group">
            ...
            <input class="form-control" data-match="#password" data-error="Hasła muszą być identyczne" type="password" required>
            <div class="help-block with-errors"></div>
        </div>
        <button type="submit" class="btn btn-primary pull-right">Zarejestruj</button>
        <p class="exsist">Masz juz konto? <a href="login.php">Zaloguj się!</a></p>
    </form>
</body>
